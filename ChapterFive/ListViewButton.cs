	...
	class ListViewButton : ContentPage // Customizing List Rows
	{
		...
		public ListViewButton()
		{
			...
			listView.ItemsSource = new ListItem[] {
				new ListItem {Title = "First", Description="1st item", Price="1"},
				new ListItem {Title = "Second", Description="2nd item", Price="2"},
				new ListItem {Title = "Third", Description="3rd item", Price="3"}
			};
		...
		class ListItemCell : ViewCell
		{
			...
			List<string> demise = new List<string> { "Die", "Live", "Suffer", "Just Die" };
			public ListItemCell()
			{
				...
				{
					Text =demise[rnd.Next(demise.Count)],
				...
				button.Clicked += (sender, e) =>
				{
					...
					((ContentPage)((ListView)((StackLayout)((StackLayout)b.ParentView).ParentView).ParentView).ParentView).DisplayAlert("Clicked", item.Title.ToString() + " button was clicked : "+button.Text, "OK");
					button.Text = demise[rnd.Next(demise.Count)];
				};
